...
songs_train, songs_val, train_label, val_label = train_test_split(songs['lyrics'], songs['genre_num'], test_size=0.3, random_state=5)
...
model = transformers.BertForSequenceClassification.from_pretrained('distilbert-base-uncased')
...
lyrics_val = preprocess_func(songs_val.tolist())
